...
if __name__ == '__main__':
    ...
    if len(os.listdir(config.FINE_TUNE_DATA)) == 0:
        print("...no data get from path : " + data_set)
        print("Reading Data, function = load_train_proposal, dataSource: " + config.FINE_TUNE_LIST)
    ...
    if os.path.isfile(config.FINE_TUNE_MODEL_PATH + '.index'):
        restore = True
        print("...found model variable data for fine_tune_model exists in directory, continue fine-tune !")
