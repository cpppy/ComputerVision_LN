...
if __name__ == "__main__":
    ...
    # size of region proposal is 224*224*3
    # labels is common used by all region proposals for one image
    # sample of labels :[0, 1 ,0]; one hot code; 2 kinds of flowers and one background
    print(len(images[0]))
